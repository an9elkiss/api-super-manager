...
public class TypeMap {
	...
	public static Map<String,String> getProjectMap(){
		...
		map.put(ApiStatus.PROJECT_11.getCode().toString(), ApiStatus.PROJECT_11.getMessage().toString());
		map.put(ApiStatus.PROJECT_12.getCode().toString(), ApiStatus.PROJECT_12.getMessage().toString());
		return map;
	}
