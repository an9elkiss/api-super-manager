...
public class TaskWeekServiceImpl implements TaskWeekService{
    ...
    private Integer creatTaskandWeek(Task task,TaskWeek taskWeek,Map<String, Object> searchParams,Integer parentid,boolean isParent){
    ...
    public ApiResponseCmd<Map<String, Object>> findActualScoreByUserIdsAndDate(Map<String, Object> searchParams){
        ...
        if (null == searchParams.get("userIds") || "".equals(searchParams.get("userIds")) || null == searchParams.get("year") || "0".equals(searchParams.get("month")) || "0".equals(searchParams.get("year"))){
            return ApiResponseCmd.deny();
        }
        ...
        if (null == searchParams.get("month")){
            ...
            if (Calendar.getInstance().get(Calendar.YEAR) <= Integer.valueOf(String.valueOf(searchParams.get("year")))){
                ...
                for (int j = 0; j < array.length; j++){
                    ...
                    for (int i = 0; i < Calendar.getInstance().get(Calendar.MONTH) + 1; i++){
                        ...
                        try{
                            ...
                            params.put("startDate", DateTools.getFirstDayOfWeek(Integer.parseInt((String) searchParams.get("year")), i + 1, 1));
                            params.put("endDate", DateTools.getLastDayOfWeek(Integer.parseInt((String) searchParams.get("year")), i + 1, DateTools.getWeekCount((String) searchParams.get("year"), String.valueOf(i + 1))));
        ...
        //month !=null  返回月的基本贡献值  以周为单位
            ...
            try{
                for (int j = 0; j < array.length; j++){
                    ...
                    for (int i = 0; i < DateTools.getWeekCount(String.valueOf(searchParams.get("year")), String.valueOf(searchParams.get("month"))); i++){

                        params.put("id", array[j]);
                        params.put("startDate", DateTools.getFirstDayOfWeek(Integer.parseInt((String) searchParams.get("year")), Integer.parseInt((String) searchParams.get("month")), i + 1));
                        params.put("endDate", DateTools.getLastDayOfWeek(Integer.parseInt((String) searchParams.get("year")), Integer.parseInt((String) searchParams.get("month")), i + 1));
    ...
    public ApiResponseCmd<Map<String, Object>> findActualScoreByUserIdsAndDateTotal(Map<String, Object> searchParams){
        ...
        if (null == searchParams.get("month")){
            for (int j = 0; j < array.length; j++){
                try{
                    params.put("id", array[j]);
                    params.put("startDate", DateTools.getFirstDayOfWeek(Integer.parseInt((String) searchParams.get("year")), 1, 1));
                    params.put("endDate", DateTools.getLastDayOfWeek(Integer.parseInt((String) searchParams.get("year")), 12, DateTools.getWeekCount((String) searchParams.get("year"), "12")));
        ...
        //month !=null    返回月的基本贡献值总计
            ...
            for (int j = 0; j < array.length; j++){
                try{
                    params.put("id", array[j]);
                    params.put("startDate", DateTools.getFirstDayOfWeek(Integer.parseInt((String) searchParams.get("year")), Integer.parseInt((String) searchParams.get("month")), 1));
                    params.put(
                                    "endDate",
                                    DateTools.getLastDayOfWeek(
                                                    Integer.parseInt((String) searchParams.get("year")),
                                                    Integer.parseInt((String) searchParams.get("month")),
                                                    DateTools.getWeekCount((String) searchParams.get("year"), (String) searchParams.get("month"))));
